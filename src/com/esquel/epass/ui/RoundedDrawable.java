...
public class RoundedDrawable extends Drawable {
	...
	private final float padding = 0.5f;
	...
	private void updateShaderMatrix() {
		...
		case CENTER:
			...
			mShaderMatrix
					.setTranslate((int) ((mBorderRect.width() - mBitmapWidth)
							* padding + padding),
							(int) ((mBorderRect.height() - mBitmapHeight)
									* padding + padding));
			break;
		...
		case CENTER_CROP:
			...
			if (mBitmapWidth * mBorderRect.height() > mBorderRect.width()
				...
				dx = (mBorderRect.width() - mBitmapWidth * scale) * padding;
			} else {
				scale = mBorderRect.width() / (float) mBitmapWidth;
				dy = (mBorderRect.height() - mBitmapHeight * scale) * padding;
			}

			mShaderMatrix.setScale(scale, scale);
			mShaderMatrix.postTranslate((int) (dx + padding) + mBorderWidth,
					(int) (dy + padding) + mBorderWidth);
			break;
		...
		case CENTER_INSIDE:
			...
			dx = (int) ((mBounds.width() - mBitmapWidth * scale) * padding + padding);
			dy = (int) ((mBounds.height() - mBitmapHeight * scale) * padding + padding);
