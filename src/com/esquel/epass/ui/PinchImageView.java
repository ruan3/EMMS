...
public class PinchImageView extends ImageView {
    ...
    private void sharedConstructing(Context mContext) {
        ...
        final int sizeArray = 9;
        m = new float[sizeArray];
        normalizedScale = 1;
        minScale = 1;

        final int maxOfScale = 3;
        maxScale = maxOfScale;
    ...
    @Override
    public void onRestoreInstanceState(Parcelable mState) {
        if (mState instanceof Bundle) {
            Bundle bundle = (Bundle) mState;
    ...
    private void translateMatrixAfterRotate(int axis, float trans,
        ...
        if (imageSize < viewSize) {
            ...
            // Center it.
            //
            m[axis] = (viewSize - (drawableSize * m[Matrix.MSCALE_X])) * RATIO;
            ...
            // Center it.
            //
            m[axis] = -((imageSize - viewSize) * RATIO);
            ...
            //
            float percentage = (Math.abs(trans) + (RATIO * prevViewSize))
                    / prevImageSize;
            m[axis] = -((percentage * imageSize) - (viewSize * RATIO));
        }
    }
    ...
    private class GestureListener extends
        ...
        public boolean onSingleTapConfirmed(MotionEvent e) {
            /**
             * #518: Click on image view to return to the article view
             */
            ((Activity) PinchImageView.this.getContext()).finish();
            return true;
        }
     ...
     * content. True, to clip return value to the bounds of the bitmap size.
     * 
